...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Banner */}
      <div
        className="relative w-full overflow-hidden rounded-sm border-2 border-foreground/70 shadow-[4px_4px_0px_rgba(0,0,0,0.55)]"
        style={{
          aspectRatio: '5/1',
          background: 'linear-gradient(135deg, oklch(0.11 0.055 258) 0%, oklch(0.20 0.09 258) 40%, oklch(0.82 0.185 93 / 0.15) 100%)',
        }}
      >
        <img
